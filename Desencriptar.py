def desencriptar(escolhaInicial):
    ...
    p = int(input("Por favor insira o primeiro primo informado anteriormente: ")) #primeiro primo informado
    q = int(input("Por favor insira segundo primo informado anteriormente: ")) #segundo primo informado
    e = input("Por favor insira o numero relativamente primo informado anteriormente: ") #numero relativamnte primo
